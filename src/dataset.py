...
class PairedDataset(torch.utils.data.Dataset):
    # 1. Add degrade_inputs argument to init
    def __init__(self, dataset_path, split, height=512, width=512, tokenizer=None, degrade_inputs=False):
        super().__init__()
        ...
        self.degrade_inputs = degrade_inputs # Store the flag
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # 2. Only degrade if the flag is True
